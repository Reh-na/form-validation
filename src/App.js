...
<section  style={{backgroundColor:'#e699ff'}} >
          ...
          <div className="card-body p-md-2">
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" id="head1">Sign up</p>
...

{
  ...
  <div style={{ color: '#ffffff', fontSize: '12px', fontFamily: "'Noto Sans JP', sans-serif;", }} className='mt-1 ms-5'>
    Password contains one Capital letter and start with @ or #,It should be alphanumeric,Length between 8 to 14.              
              ...
              <button type='submit' style={{ marginLeft: '40px'}} class="btn btn-success mt-2 mb-2"
                disabled={validname && validEmail && validPassword && validconfirmPassword ? false : true}>SIGN UP</button>
              <button onClick={clearform} type='button' style={{ marginLeft: '86px' }} class="btn btn-danger mt-2 mb-2">CLEAR</button>
            </div>
